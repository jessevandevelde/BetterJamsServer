...
import { EmptyQueue } from './components/empty-queue/empty-queue.component';

@Component({
  selector: 'app-room-page',
  standalone: true,
  imports: [QueueRowComponent, MediaPlayerComponent, SearchBarComponent, UserProfileComponent, EmptyQueue],
